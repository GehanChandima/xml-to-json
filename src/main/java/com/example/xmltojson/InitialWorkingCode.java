...
public class InitialWorkingCode {	public static void main(String[] args) throws IOException {
...
//
    ...
    try {
        ...
        formattedXmlString = removeTag(formattedXmlString, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>");
